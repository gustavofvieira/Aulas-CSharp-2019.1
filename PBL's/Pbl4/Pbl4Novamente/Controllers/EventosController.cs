...
namespace Pbl4Novamente.Controllers
{
    public class EventosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventoId,Nome,Data,HoraInicio,HoraTermino,Restricao")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventoId,Nome,Data,HoraInicio,HoraTermino,Restricao")] Evento evento)
        {
            if (ModelState.IsValid)
            {
